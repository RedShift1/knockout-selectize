(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(["jquery", "knockout", "knockout-mapping", "knockout-reactor", "selectize", "selectable-placeholder"],
            function ($, ko, knockoutMapping, knockoutReactor, Selectize, selectablePlaceholder) {
...
}(this, function ($, ko, knockoutMapping, knockoutReactor, Selectize, selectablePlaceholder) {
    ...
    var initialize = function(el, valueAccessor, allBindings) {
        ...
        var options = allBindings.get("options") || ko.observableArray();
        var subscriptions = {
            options: false,
            value: false
        };

        // Override default options for selectize.js with options given by
        // the selectizeSettings binding
        var selectizeSettings = $.extend({
            labelField: "text",
            optgroupLabelField: "name",
            optgroupValueField: "name",
            plugins: [],
            valueField: "value"
        }, allBindings.get("selectizeSettings") || {});
        ...
        if (selectizeSettings.allowEmptyOption === true) {
